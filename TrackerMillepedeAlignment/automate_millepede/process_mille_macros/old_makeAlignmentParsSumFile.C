...
void makeAlignmentParsSumFile()
{
  ...
  // if(iter_num == 0)
  //   {
  //     inputFile = "/sphenix/tg/tg01/hf/rboucher43/eval_output/misalignment_files/og_localAlignmentParamsFile.txt";
  //   }
  // else
  //   {
  //     inputFile = Form("/sphenix/tg/tg01/hf/rboucher43/eval_output/misalignment_files/sumAlignmentPars_run%f_iter%d.txt", run_num, iter_num);
  //   }

  //std::cout << "Input Sum file " << inputFile << std::endl;
  ifstream foriginal("/sphenix/tg/tg01/hf/rboucher43/eval_output/misalignment_files/sumAlignmentPars_run1_iter0.txt");
  ...
  // if(iter_num=0)
  //   {
  //     outputFile = "/sphenix/tg/tg01/hf/rboucher43/eval_output/misalignment_files/sumAlignmentPars_run1_iter0.txt");
  //   }
  // else
  //   {
  //     outputFile = Form("/sphenix/tg/tg01/hf/rboucher43/eval_output/misalignment_files/sumAlignmentPars_run%f_iter%d.txt", run_num, iter_num);
  //   }
//std::cout << " output file " << outputFile << std::endl;

  ofstream fsum("/sphenix/tg/tg01/hf/rboucher43/eval_output/misalignment_files/sumAlignmentPars_run1_iter1.txt");
